...
<body style="font-family: Arial, sans-serif; color: #333;">
    ...
    <p style="margin: 24px 0;">
        <a href="<?= htmlspecialchars((string) $verificationUrl, ENT_QUOTES, 'UTF-8') ?>" style="background: #0d6efd; color: #fff; padding: 12px 20px; border-radius: 6px; text-decoration: none;">Verify Email</a>
    </p>
